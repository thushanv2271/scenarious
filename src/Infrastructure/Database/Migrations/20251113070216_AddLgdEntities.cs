...
/// <inheritdoc />
public partial class AddLgdEntities : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "lgd_file_details",
            schema: "public",
            columns: table => new
            {
            ...
            constraints: table => table.PrimaryKey("pk_lgd_file_details", x => x.id));
        ...
        migrationBuilder.CreateTable(
            ...
            {
                id = table.Column<Guid>(type: "uuid", nullable: false),
                lgd_file_details_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                discount_factor = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("pk_lgd_details", x => x.id);
                table.ForeignKey(
                    name: "fk_lgd_details_lgd_file_details_lgd_file_details_id",
                    column: x => x.lgd_file_details_id,
                    principalSchema: "public",
                    principalTable: "lgd_file_details",
                    principalColumn: "id",
                    onDelete: ReferentialAction.Cascade);
            });

        migrationBuilder.CreateIndex(
            name: "ix_lgd_details_lgd_file_details_id",
            schema: "public",
            table: "lgd_details",
            column: "lgd_file_details_id");
    }
