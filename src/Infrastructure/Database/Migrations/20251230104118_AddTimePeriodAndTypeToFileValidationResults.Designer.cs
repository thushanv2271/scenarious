...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20251230104118_AddTimePeriodAndTypeToFileValidationResults")]
    partial class AddTimePeriodAndTypeToFileValidationResults
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Scenarios.Scenario", b =>
                {
                    ...
                    b.Property<bool>("CollateralValueEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("collateral_value_enabled");

                    b.Property<bool>("ContractualCashFlowsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("contractual_cash_flows_enabled");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_at");

                    b.Property<bool>("LastQuarterCashFlowsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("last_quarter_cash_flows_enabled");

                    b.Property<bool>("OtherCashFlowsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("other_cash_flows_enabled");
                    ...
                    b.HasIndex("SegmentId", "ScenarioName")
                        .IsUnique()
