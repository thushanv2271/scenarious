...
/// <summary>
/// Entity configuration for VCLgdDetails
/// </summary>
internal sealed class VCLgdDetailsConfiguration : IEntityTypeConfiguration<VCLgdDetails>
{
    public void Configure(EntityTypeBuilder<VCLgdDetails> builder)
    {
        ...
        builder.Property(x => x.VCLgdFileDetailsId)
            .IsRequired();
        ...
        builder.HasOne(x => x.VCLgdFileDetails)
            .WithMany(x => x.VCLgdDetails)
            .HasForeignKey(x => x.VCLgdFileDetailsId)
            .OnDelete(DeleteBehavior.Cascade);

        builder.ToTable("vc_lgd_details");
    }
}