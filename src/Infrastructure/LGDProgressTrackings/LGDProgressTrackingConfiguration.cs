...
namespace Infrastructure.LGDProgressTrackings;

internal sealed class LgdProgressTrackingConfiguration : IEntityTypeConfiguration<LgdProgressTracking>
{
    public void Configure(EntityTypeBuilder<LgdProgressTracking> builder)
    {
        ...
        // Table name
        builder.ToTable("lgd_progress_tracking");
    }
}
