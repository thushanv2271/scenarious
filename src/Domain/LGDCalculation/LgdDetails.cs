...
/// <summary>
/// Represents LGD details extracted from LGD calculation files
/// </summary>
public sealed class LgdDetails : Entity
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the file details ID this LGD record belongs to
    /// </summary>
    public Guid LgdFileDetailsId { get; set; }
    ...
    /// <summary>
    /// Gets the file details this LGD record belongs to
    /// </summary>
    public LgdFileDetails LgdFileDetails { get; set; } = null!;

    /// <summary>
    /// Creates a new LgdDetails instance from a creation request
    /// </summary>
    /// <param name="request">The LGD details creation request</param>
    /// <returns>A new LgdDetails instance</returns>
    public static LgdDetails Create(LgdDetailsCreationRequest request)
    {
        return new LgdDetails
        {
            Id = Guid.NewGuid(),
            LgdFileDetailsId = request.LgdFileDetailsId,
...
/// <summary>
/// Request object for creating LGD details
/// </summary>
public sealed record LgdDetailsCreationRequest(
