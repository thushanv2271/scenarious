...
/// <summary>
/// Represents file details information for VC LGD calculation files
/// </summary>
public sealed class VCLgdFileDetails : Entity
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the collection of VC LGD details associated with this file
    /// </summary>
    public ICollection<VCLgdDetails> VCLgdDetails { get; set; } = new List<VCLgdDetails>();

    /// <summary>
    /// Creates a new VCLgdFileDetails instance
    /// </summary>
    ...
    /// <returns>A new VCLgdFileDetails instance</returns>
    public static VCLgdFileDetails Create(
        string fileName,
        int year,
        int part,
        string period,
