...
internal sealed class UpdateAgeBucketConfigurationCommandHandler(
    IApplicationDbContext context)
    : ICommandHandler<UpdateAgeBucketConfigurationCommand, bool>
{
    public async Task<Result<bool>> Handle(
        UpdateAgeBucketConfigurationCommand command,
        CancellationToken cancellationToken)
    {
        AgeBucketConfiguration? configuration = await context.AgeBucketConfigurations
        ...
        configuration.ModifiedOnUtc = DateTime.UtcNow;
